...
const employeeNamedFrederique = employees.some((employee) => {
  return employee.firstName === "Frederique";
});
...
const employeeYoungerThan18 = employees.some((employee) => {
...
const everyEmployeeHasFirstAndLastName = employees.every((employee) => {
...
const employeeWithId = employees.find((employee) => {
  return employee.id === "0.0795620650485831";
});
...
const employeesSortedByAge = employees.toSorted(
  (employeeAge0, employeeAge100) => {
    return employeeAge0.age - employeeAge100.age;
  }
);
...
const employeesSortedByLastName = employees.toSorted((nameA, nameB) => {
  return nameB.lastName - nameA.lastName;
});
