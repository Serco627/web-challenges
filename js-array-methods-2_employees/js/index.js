...
console.log(findByLastName(employees, "Cirillo")); // true
console.log(findByLastName(employees, "Smith")); // undefined, gibt keinen mit Nachnamen Smith
...
console.log(findById(employees, "0.6319249290273428")); // Found: Employee Schilder
console.log(findById(employees, "0.6319248")); // undefined, gibt keinen mit der ID
...
function findByProfessionSubStringAndAge(employeesArray, string, age) {
  return employees.find((employee) => {
    return employee.profession.includes(string) && employee.age > age;
  });
}
console.log(findByProfessionSubStringAndAge(employees, "Software", 20));
