...
function printCircumference(radius) {
  //console.log(`2 * Math.Pi ${radius}`); CODE IS NOT WORKING
...
// oder so, weil der auskommentierte code nicht geklappt hat
function printCircumference(radius) {
...
function printRectangleArea(width, length) {
  ...
  console.log(`The area  of the rectangle is: ${solution}`);
}
